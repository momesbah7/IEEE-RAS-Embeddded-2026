...
void DIO_SetPinDirection(u8 copy_port_id, u8 copy_pin_id, u8 copy_pin_dir);
void DIO_SetPinValue(u8 copy_port_id, u8 copy_pin_id, u8 copy_pin_val);
u8   DIO_GetPinValue(u8 copy_port_id, u8 copy_pin_id);
